...
var SentenciaDoWhile = /** @class */ (function (_super) {
    __extends(SentenciaDoWhile, _super);
    function SentenciaDoWhile(condicion, lista) {
    ...
    SentenciaDoWhile.prototype.printSentencia = function () {
