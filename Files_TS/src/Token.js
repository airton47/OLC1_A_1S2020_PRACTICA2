...
(function (TipoToken) {
    ...
    TipoToken[TipoToken["KW_BREAK"] = 31] = "KW_BREAK";
    TipoToken[TipoToken["KW_CONTINUE"] = 32] = "KW_CONTINUE";
    TipoToken[TipoToken["KW_RETURN"] = 33] = "KW_RETURN";
    TipoToken[TipoToken["KW_CONSOLE"] = 34] = "KW_CONSOLE";
    TipoToken[TipoToken["KW_WRITE"] = 35] = "KW_WRITE";
    TipoToken[TipoToken["KW_DO"] = 36] = "KW_DO";
    TipoToken[TipoToken["KW_FOR"] = 37] = "KW_FOR";
    TipoToken[TipoToken["KW_WHILE"] = 38] = "KW_WHILE";
    TipoToken[TipoToken["KW_IF"] = 39] = "KW_IF";
    TipoToken[TipoToken["KW_SWITCH"] = 40] = "KW_SWITCH";
    TipoToken[TipoToken["WK_CASE"] = 41] = "WK_CASE";
    TipoToken[TipoToken["KW_VOID"] = 42] = "KW_VOID";
    TipoToken[TipoToken["KW_MAIN"] = 43] = "KW_MAIN";
    TipoToken[TipoToken["ERROR"] = 44] = "ERROR";
})(TipoToken || (TipoToken = {}));
